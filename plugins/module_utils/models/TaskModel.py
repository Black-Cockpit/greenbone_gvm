...
class TaskModel(object):
    ...
    Args:
        name (str)                                      : Task name
        comment (str)                                   : Description of the task
    ...
    def __init__(self, name: str = None, comment: str = None, target_name: str = None, schedule_name: str = None,
                 ...
                 auto_delete_data: int = 1, scanner_name: str = None, config_name: str = None,
    ...
    def config_name(self, config_name: str):
        if config_name is None or config_name == '' or config_name.isspace():
    ...
    def get_task_id(self, task_list: dict, name: str) -> str:
        """
    ...
    def get_config_id(self, config_list: dict, name: str) -> str:
        """
